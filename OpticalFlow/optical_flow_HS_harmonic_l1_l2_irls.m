...
% L_1 data fidelity and L_1 norm of the gradient as regularizer (Model II).
%
...
% 
% lambda: >= 0, regularization parameter for the L_1 penalty 
%
...
for irls_it = 1:itmax
    ...
    % Construct the system corresponding to (17) in [1]
    ...
    C = @(x) afun(x,flag,d,nt,lambda,IxIxf0,IxIxf2w,IxIyf0,IxIyf2w,IyIyf0,IyIyf2w, weights,fwR0, fwR2w);
    % Run CG to solve (17) in [1]
...
% Compute residual in the regularizer term
