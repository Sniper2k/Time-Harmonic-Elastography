function [ u, v ] = pdhg( I1, I2, u, v, sigma, tau, lambda, theta, iterations )
% Computes optical flow on one scale of the ctf scheme with a variational model and TV regularizer.
...
for k=1:iterations    
    ...
    % Step 2: Update p1, p2
    p_old = p;
    p = cProjectInf2_4(p + sigma * [Dx * u; u * Dyt; Dx * v; v * Dyt], lambda);    
